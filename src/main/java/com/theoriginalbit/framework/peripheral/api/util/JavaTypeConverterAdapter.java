...
import com.theoriginalbit.framework.peripheral.api.converter.IJavaTypeConverter;

/**
 * @author Joshua Asbury (@theoriginalbit)
 */
public class JavaTypeConverterAdapter extends GenericInboundConverterAdapter {
    private final IJavaTypeConverter converter;

    public JavaTypeConverterAdapter(IJavaTypeConverter converter) {
