 ...
 */
public interface ILuaTypeConverter {
    /**
     * Converts a value from a Java type to a Lua type or returns null if it cannot convert
     *
     ...
     */
    Object toLua(IConversionRegistry registry, Object obj) throws TypeConversionException;
}
